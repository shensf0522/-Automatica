...
python -u run.py \
    ...
    --positive_nums 3 \
    --negative_nums 1 \
    ${COMMON_ARGS} >logs/pretrain/$EXP_NAME'_'$MODEL_NAME'_'$DATASET'_'$SEQ_LEN.log
...
for FORECAST_MODE in freq unfreq; do
  for PRED_LEN in 96 192 336 720; do
    python -u run.py \
        ...
        ${COMMON_ARGS} >logs/LongForecasting/$EXP_NAME'_'$MODEL_NAME'_'$DATASET'_'$SEQ_LEN'_'$PRED_LEN.log
  done
done
